...
// 文件上传到服务器的路径,存储在本地的
const dirPath = path.join(__dirname, '..', '/public/UploadImages/wave-forms/' + utils.getNowFormatDate())
...
router.post('/upload', upload.single('image'), (req, res) => {
    ...
    WaveFormsModel.create({
        ...
        path: '/UploadImages/wave-forms/' + utils.getNowFormatDate() + '/' + file.originalname,
        type: fileTyppe,
...
/**
 * @api {get} /waveforms/search/all  查询波形图
 * @apiDescription 查询波形图
 * @apiName 查询波形图
 * @apiGroup WaveForms
 * @apiParam {String} point_id 点位图id（外键）
 * @apiSuccess {json} result
 * @apiSuccessExample {json} Success-Response:
 *  {
 *      "status" : "200",
 ...
 *      "data": img
 *  }
 * @apiSampleRequest http://localhost:5050/waveforms/search/all
 * @apiVersion 1.0.0
 */
